module.exports = {
    en: {
        translation: {
            WELCOME_MSG_INIT: `Welcome to the Edifi Podcasts. Edifi Podcasts is a Christian-centric powerful podcast player, you can say, begin the podcast, to start, or say help, to check more functions! `,
            WELCOME_MSG: `Welcome to the Edifi Podcasts, you can say, begin the podcast, to start, or say help, to check more functions! `,
            ...
            HELP_IN_SEARCH_MSG: [' You can also search podcasts by saying, Alexa, search', ' Or say, Alexa, search + keywords, to search podcasts.'],
            ...
            START_PLAYING_HELP_MSG: `You can say, Next or Previous to navigate through your playlist. You can also say Alexa, ask Edifi Podcasts see my playlist, to look through the playlist! Or say, Alexa, ask Edifi Podcasts play + ministry name or pastor name, to change channel!`,
            ...
            CHANNEL_SEARCH_RESULTS_PROMPT_MSG2: `You can use number, instead of name by saying, for example, channel 5, to start the podcast. Or say Yes to start channel 4; say No to play the latest featured episodes.`,
