module.exports = {
    en: {
        translation: {
            ...
            HELP_IN_LISENING_MSG: `You are listening to  {{description}} . You can say, Alexa, see playlist, to look through the playlist. You can also say, Alexa, play + ministry name or preacher name, to start a new podcast! Or say, Alexa, search + keywords, to search episodes. `,
            HELP_IN_QUESTION_MSG: `You can say, Alexa, play + ministry name or preacher name, to start one podcast! Or say, Alexa, see recommended channels, to see recommended channel list.`,
            ...
            START_PLAYING_HELP_MSG: `You can say, Next or Previous to navigate through your playlist. You can also say Alexa, ask Christian Podcast see my playlist, to look through the playlist! Or say, Alexa, ask Christian Podcast play + ministry name or preacher name, to change channel!`,
