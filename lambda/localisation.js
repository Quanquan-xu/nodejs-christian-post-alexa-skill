module.exports = {
    en: {
        translation: {
            ...
            HELP_IN_LISENING_MSG: `You are listening to  {{description}} . You can say, Alexa, see the playlist, to look through the playlist. You can also say, Alexa, see the channel list, to check recommended channels! Or say, Alexa, search channels or episodes, to search channels or episodes. `,
            ...
            UPDATELATEST_RESOURCES_PROGRESSIVE_MSG: ['OK! Let me first update the latest resources for you... ', 'Got it! Let me first update the latest resources for you...  ', 'No Problem! Let me first update latest resources for you... '],
            ...
            START_PLAYING_HELP_MSG: `You can say, Next or Previous to navigate through your playlist. You can also say Alexa, ask Edifi Podcasts to see my playlist, to look through the playlist! Or say, Alexa, ask Edifi Podcasts play channel + number, to change channel!`,
            LIST_PROMPT_NOTIFICATION_MSG: `You can use a number, instead of name by saying, for example, alexa, {{name}} {{number}}, to start podcasts! `,
