module.exports = {
    en: {
        translation: {
            ...
            START_PLAYING_RESUME_MSG: `Last time, You have heard {{description}} around {{minute}} minutes. Would you like to resume? `,
            START_PLAYING_RESUME_MSG_REPROMPT: 'You can say yes to resume or no to play from the top.',
            START_PLAYING_HELP_MSG: `You can say, Next or Previous to navigate through your playlist. You can also say Alexa, ask Edifi Podcast my playlist, to check playlist! Or say, Alexa, ask Edifi Podcast play channel + number, to change channel!`,
            LIST_PROMPT_NOTIFICATION_MSG: `You can use number, instead of name by saying, for example, alexa, {{name}} {{number}}, to start podcast! `,
            LIST_ONLY_TOP_FIVE_NOTIFICATION_MSG: ` Here are top 5 {{name}} : `,
            LIST_PROMOTION_EPISODES_NOTIFICATION_MSG_FOR_CHANNEL: `{{length}} lastest promotion episodes are available, you can say alexa, play promotion episodes, to change your playlist! `,
            LIST_PROMOTION_EPISODES_NOTIFICATION_MSG_FOR_EPISODES: `{{length}} lastest promotion episodes are available, also in your playlist. `,
            LIST_PLAYLIST_NOTIFICATION_MSG_HEADER_FRO_CHANNEL: `{{length}} lastest episodes from channel {{name}} are available in your playlist. `,
            LIST_PLAYLIST_NOTIFICATION_MSG_HEADER_FRO_PROMOTION: `{{length}} lastest promotion episodes are available in your playlist. `,
