module.exports = {
    en: {
        translation: {
            WELCOME_MSG: `Welcome to the Edifi Podcasts. Edifi Podcasts is a Christian-centric powerful podcast player, you can say, begin the podcast, to start, or say help, to check more functions! `,
            ...
            BUILT_IN_HELP_WEL_VERSE:'Welcome to the Edifi Podcasts! Edifi is a collection of transformational and faith-inspiring podcasts. ',
            ...
            START_PLAYING_HELP_MSG: `You can say, Next or Previous to navigate through your playlist. You can also say Alexa, ask Edifi Podcasts see my playlist, to look through the playlist! Or say, Alexa, ask Edifi Podcasts play channel + number, to change channel!`,
